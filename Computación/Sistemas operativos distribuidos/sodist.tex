...
\section{Componentes de un sistema distribuido}
    ...
    En el modelo cliente-servidor, una serie de ordenadores cliente operan sobre otra serie denominada 
    máquina servidor, presentando un modelo de 3 capas:

    \begin{itemize}
        \item \textbf{Capa de presentación}. Envío, recibimiento y muestreo de los datos, interactuando 
        directamente con el usuario final.
        \item \textbf{Capa de negocio}. Gestión de información y solicitud de recursos.
        \item \textbf{Capa de datos}. Trasvase de información de entrada y salida.
    \end{itemize}

    \begin{figure}[htp]
        \centering
        \includegraphics[width=0.8\textwidth]{resources/division_capas_so.png}
        \caption{Divisisón por capas de los sistemas operativos}
        \label{division_capas_so}
    \end{figure}
