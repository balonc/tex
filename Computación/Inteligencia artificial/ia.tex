...
\section{Procesos basados en reglas}
    ...
    \subsection{Cálculo lógico}
        ...
        \subsubsection{Inferencia mediante deducción natural y relaciones de equivalencia}
            ...
            P. Ej: <<no es posible mojarse si llevo paraguas>>, siendo $p$ mojarse 
            y $q$ llevar paraguas, siendo: 
            
            \[ \neg (p \land q) \]
            
            Aplicando la primera ley de DeMorgan quedaría como <<o no me mojo, o no llevo paraguas>>, 
            es decir:
            ...
            P. Ej: <<los hombres no pueden volar o mantenerse bajo el agua indefinidamente>>, siendo 
            $p$ volar y $q$ mantenerse bajo el agua; obtendríamos:

            \[ \neg (p \lor q) \]

            Aplicando la segunda ley de DeMorgan se transformaría en:
