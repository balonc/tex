...
\section*{Prólogo}
    ...
    El presente documento corresponde al trabajo obligatorio del módulo \textit{Seguridad en redes}, 
    parte del curso académico del \textit{Grado en Ingeniería Informática de Sistemas} de la \textit{Universidad 
    Católica de Santa Teresa, Ávila}.

    Ha sido desarrollado por \textit{Francisco Javier Balón Aguilar}, y en éste se trata el tema en profundidad 
    del protocolo SSH, partiendo desde sus cimientos, hasta su robustecimiento o hardening, pasando por 
    utilidades prácticas que embeben dicho protocolo, con el objetivo no sólo el de securizar el propio 
    SSH, sino securizar todo un entorno de redes por medio de éste.
...
\section{Introducción a SSH}
    ...
    \begin{figure}[htp]
        \centering
        \includegraphics[width=1\textwidth]{resources/telnetssh.png}
...
\section{Configuración del servicio}
    ...
    \subsection{Autenticación mediante par de claves}\label{PubkeyAuthentication}
        ...
        \begin{figure}[htp]
            \centering
            \includegraphics[width=0.8\textwidth]{resources/keyauth.png}
            \caption{Visión gráfica de proceso de autenticación por medio de par de claves.}
            \label{keyauth}
        \end{figure}        
...
\section{Aplicaciones de SSH}
    ...
    \subsection{SSHFS}
        ...
        \begin{figure}[htp]
            \centering
            \includegraphics[width=0.4\textwidth]{resources/ssh04.png}
    ...
    \subsection{X11 forwarding}\label{X11Forwarding}
        ...
        \begin{figure}[htp]
            \centering
            \includegraphics[width=1\textwidth]{resources/ssh05.png}
...
\section{Tunneling}
    ...
    $ ssh -L [direccion de escucha:]puerto escucha:maquina remota: puerto remoto 
      usuario@host\end{lstlisting}
        ...
        \begin{figure}[htp]
            \centering
            \includegraphics[width=1\textwidth]{resources/localtunneling.png}
    ...
    $ ssh -R puerto local:maquina remota:puerto remoto\end{lstlisting}
        ...
        \begin{figure}[htp]
            \centering
            \includegraphics[width=1\textwidth]{resources/remotetunneling.png}
...
\begin{thebibliography}{X}
    ...
    \bibitem{st} Secure vs. cleartext protocols - couple of stats \\ \url{https://isc.sans.edu/forums/diary/Secure+vs+cleartext+protocols+couple+of+interesting+stats/25854/}
\end{thebibliography}
